...
{
    private FormTel $helper;

    /** @throws void */
    protected function setUp(): void
    {
        $this->helper = new FormTel();
    }
    ...
    public function testRenderHtml(): void
    {
        ...
        $expected = sprintf(
            '<input class-escaped="%s" nameEscaped="%s" typeEscaped="tel-escaped" valueEscaped="%s">',
            $classEscaped,
            $nameEscaped,
            $valueEscaped,
        );
    ...
    public function testRenderReadonlyXHtml(): void
    {
        ...
        $expected = sprintf(
            '<input class-escaped="%s" readonlyEscaped="readonly-escaped" nameEscaped="%s" typeEscaped="tel-escaped" valueEscaped="%s"/>',
            $classEscaped,
            $nameEscaped,
            $valueEscaped,
        );
