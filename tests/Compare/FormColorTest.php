...
use Mimmi20\LaminasView\BootstrapForm\FormColor;
...
final class FormColorTest extends AbstractTestCase
{
    ...
    public function testRender(string $config, string $template, string $indent, array $messages): void
    {
        ...
        // file_put_contents($this->files . '/expected/' . $file, trim($helper->render($form->get('inputColor'))));
