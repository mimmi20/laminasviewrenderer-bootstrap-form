...
final class FormDateTimeSelectTest extends AbstractTestCase
{
    /**
    ...
    public static function providerTests(): array
    {
        return [
            'date-time-select' => [
                'config' => 'date-time-select.config.php',
                'template' => 'date-time-select.html',
                'indent' => '',
                'messages' => [],
            ],
            'date-time-select.seconds' => [
                'config' => 'date-time-select.seconds.config.php',
                'template' => 'date-time-select.seconds.html',
                'indent' => '',
                'messages' => [],
            ],
        ];
