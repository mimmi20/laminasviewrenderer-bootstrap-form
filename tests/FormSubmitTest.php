...
use Mimmi20\LaminasView\BootstrapForm\FormSubmit;
...
{
    private FormSubmit $helper;

    /** @throws void */
    protected function setUp(): void
    {
        $this->helper = new FormSubmit();
    }
    ...
    public function testRenderHtml(): void
    {
        ...
        $expected = sprintf(
            '<input class-escaped="%s" nameEscaped="%s" typeEscaped="submit-escaped" valueEscaped="%s">',
            $classEscaped,
            $nameEscaped,
            $valueEscaped,
        );
    ...
    public function testRenderReadonlyXHtml(): void
    {
        ...
        $expected = sprintf(
            '<input class-escaped="%s" disabledEscaped="disabled-escaped" nameEscaped="%s" typeEscaped="submit-escaped" valueEscaped="%s"/>',
            $classEscaped,
            $nameEscaped,
            $valueEscaped,
        );
