...
use Mimmi20\LaminasView\BootstrapForm\FormDateTimeLocal;
...
/**
 * @group form-datetime-local
 */
final class FormDateTimeLocalTest extends TestCase
{
    private FormDateTimeLocal $helper;

    /** @throws void */
    protected function setUp(): void
    {
        $this->helper = new FormDateTimeLocal();
    }
    ...
    public function testRenderHtml(): void
    {
        ...
        $expected = sprintf(
            '<input class-escaped="%s" nameEscaped="%s" typeEscaped="datetime-local-escaped" valueEscaped="%s">',
            $classEscaped,
            $nameEscaped,
            $valueEscaped,
        );
    ...
    public function testRenderReadonlyXHtml(): void
    {
        ...
        $expected = sprintf(
            '<input class-escaped="%s" readonlyEscaped="readonly-escaped" nameEscaped="%s" typeEscaped="datetime-local-escaped" valueEscaped="%s"/>',
            $classEscaped,
            $nameEscaped,
            $valueEscaped,
        );
