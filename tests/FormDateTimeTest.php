...
final class FormDateTimeTest extends TestCase
{
    ...
    public function testRenderHtml(): void
    {
        ...
        $expected = sprintf(
            '<input class-escaped="%s" nameEscaped="%s" typeEscaped="datetime-escaped" valueEscaped="%s">',
            $classEscaped,
            $nameEscaped,
            $valueEscaped,
        );
    ...
    public function testRenderReadonlyXHtml(): void
    {
        ...
        $expected = sprintf(
            '<input class-escaped="%s" readonlyEscaped="readonly-escaped" nameEscaped="%s" typeEscaped="datetime-escaped" valueEscaped="%s"/>',
            $classEscaped,
            $nameEscaped,
            $valueEscaped,
        );
