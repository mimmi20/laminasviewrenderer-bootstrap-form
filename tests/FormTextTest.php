...
{
    private FormText $helper;

    /** @throws void */
    protected function setUp(): void
    {
        $this->helper = new FormText();
    }
    ...
    public function testRenderHtml(): void
    {
        ...
        $expected = sprintf(
            '<input class-escaped="%s" nameEscaped="%s" typeEscaped="text-escaped" valueEscaped="%s">',
            $classEscaped,
            $nameEscaped,
            $valueEscaped,
        );
    ...
    public function testRenderReadonlyXHtml(): void
    {
        ...
        $expected = sprintf(
            '<input class-escaped="%s" readonlyEscaped="readonly-escaped" nameEscaped="%s" typeEscaped="text-escaped" valueEscaped="%s"/>',
            $classEscaped,
            $nameEscaped,
            $valueEscaped,
        );
